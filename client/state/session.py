...
def setup_session_state():
  default_state = {
    "chat_history": [],             # Stores tuples of (question, answer, provider, model, document, timestamp)
    "chat_ready": False,            # Tracks whether chat is ready to receive user input
    "pdf_files": [],                # Currently submitted PDF file
    "document_result": None,        # Backend processing result
