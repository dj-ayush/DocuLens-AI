...
class Settings(BaseSettings):
  ...
  minimum_relevance_score: float = Field(default=0.15, ge=0, le=1)
  ...
  def model_options(self) -> dict[str, dict[str, object]]:
    return {
      "groq": {"playground": "https://console.groq.com", "models": ["openai/gpt-oss-20b"]},
      "gemini": {"playground": "https://ai.google.dev", "models": ["gemini-2.0-flash", "gemini-2.5-flash"]},
    }
